  ...
  return (
    <div className="text-center animate-fade">
      ...
      <input
        ...
        className="w-full p-3 rounded-xl border border-gray-300 mb-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        value={password}
      ...
      <button
        ...
        className="text-indigo-600 mt-4 block text-sm hover:underline"
      >
        Forgot Password?
      </button>
    </div>
